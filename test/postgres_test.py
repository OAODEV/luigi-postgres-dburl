...
class DummyPostgresImporter(luigi_postgres_dburl.CopyToTable):
    date = luigi.DateParameter()

    @property
    def dsn(self):
        return "postgres://dummy_user:dummy_password@dummy_host/dummy_database"
...
class DummyPostgresQuery(luigi_postgres_dburl.PostgresQuery):
    date = luigi.DateParameter()

    @property
    def dsn(self):
        dsn = make_dsn(host='dummy_host',
